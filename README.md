...
Once I have cleaned up the data a bit, I moved the data exploration section. In this section I explored 5 high level business questions related to our data:
